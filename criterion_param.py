...
class VideoSetCriterion(nn.Module):
    ...
    def __init__(self, num_classes, matcher, weight_dict, eos_coef, losses,
        ...
        with open('myconfig.txt','r') as f:
            ...
            self.beta = ab['beta'];
            qccfuncname = ab['QCC']
            kerneltype = ab['kerneltype']
            kernelsize = ab['kernelsize']
            powertype = ab['powertype']
            corsstype = ab['corsstype']
            targettype = ab['targettype']
            scenetype = ab['scenetype']
            powerinput = ab['powerinput']
            realmag = ab['realmag']
        
        self.PCT = pctfuncZ.PCT(kerneltype,kernelsize,powertype,corsstype,targettype,scenetype,powerinput,realmag)
        
        print('alpha,beta,qccfuncname,kerneltype,kernelsize,powertype,corss,targettype,scenetype,powerinput,realmag',self.alpha,self.beta,qccfuncname,kerneltype,kernelsize,powertype,corsstype,targettype,scenetype,powerinput,realmag)
