...
class GLASS(torch.nn.Module):
    ...
    def trainer(self, training_data, val_data, name):
        ...
        #if len(ckpt_path) != 0 and False:  # Temporarily force training
        #    LOGGER.info("Checkpoint found but forcing new training")

        print('SSSSSSSSSSSSSSSSSSSSSS tart')
        ...
        for i_epoch in pbar:
            ...
            if (i_epoch + 1) % self.eval_epochs == 0:
                ...
                os.system('cp all_ckpts.zip all_ckpts2.zip)
